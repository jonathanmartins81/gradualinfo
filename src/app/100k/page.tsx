...
export default function Page100K() {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-cyan-50 dark:from-gray-900 dark:via-purple-900 dark:to-cyan-900'>
        ...
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center'>
          ...
          >
            <h1 className='text-4xl sm:text-6xl font-bold text-gray-900 dark:text-white mb-6'>
              ...
              <br />
              <span className='text-2xl sm:text-4xl'>COLEÇÃO ESPECIAL</span>
            </h1>
            <p className='text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto'>
              Descubra nossa coleção exclusiva com produtos selecionados

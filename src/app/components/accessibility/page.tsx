...
export const metadata: Metadata = generateDynamicSEO('/components/accessibility');

function AccessibilityDemo() {
  const { highContrast, fontSize, reducedMotion, setHighContrast, setFontSize, setReducedMotion } = useAccessibility();
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
            Configurações de acessibilidade para melhorar a experiência de todos os usuários
          </p>
        </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100">Alto Contraste</h3>
              ...
              {/* Tamanho da Fonte */}
              <div>
                <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Tamanho da Fonte</h3>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100">Redução de Movimento</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">

      ...
      <div className='container mx-auto px-6'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto'>
            Componente de imagem otimizada com lazy loading, placeholders e
            responsividade
          </p>
        </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div className='space-y-4'>
              <div>
                ...
                <ul className='text-sm text-gray-600 dark:text-gray-400 space-y-1'>
                  ...
                  <li>
                    • <code>alt</code> - Texto alternativo
                  </li>
                  <li>
                  ...
                  <li>
                    • <code>priority</code> - Carregamento prioritário
                  </li>
                  <li>
                    • <code>placeholder</code> - Tipo de placeholder
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className='space-y-4'>
              <div>
                ...
                <ul className='text-sm text-gray-600 dark:text-gray-400 space-y-1'>
                  <li>
                    • <code>blur</code> - Efeito blur
                  </li>
                  <li>
                    • <code>empty</code> - Sem placeholder
                  </li>
                  <li>
                    • <code>data</code> - Base64 data URL
                  </li>
                </ul>
              </div>
            </div>

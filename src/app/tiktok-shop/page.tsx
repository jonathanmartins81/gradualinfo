...
import { FaClock, FaFire, FaHeadset, FaShieldAlt, FaShoppingCart, FaStar, FaTruck, FaUser } from 'react-icons/fa';
...
export default function TikTokShopPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-red-500 via-pink-500 to-purple-600 text-white py-20">
      ...
      {/* Testimonials */}
      <section className="py-16 bg-gradient-to-r from-red-500 via-pink-500 to-purple-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <p className="italic mb-4 text-lg">"{testimonial.text}"</p>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                ...
                <li>contato@tiktokshop.com.br</li>
                <li>(11) 99999-9999</li>
              </ul>
            </div>
            <div>
          ...
          <div className="border-t border-gray-700 pt-8 text-center">
            <p className="text-gray-400">© 2024 TikTok Shop - Todos os direitos reservados</p>

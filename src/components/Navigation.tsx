...
const navigationItems: NavigationItem[] = [
  ...
  // Demos
  {
    label: 'Tailwind Demo',
    href: '/tailwind-demo',
    description: 'Demonstração do Tailwind CSS',
    category: 'demos',
  },
  {
    label: 'Theme Demo',
  ...
  {
    label: 'Dynamic SEO',
    href: '/components/dynamic-seo',
    description: 'Componente de SEO dinâmico',
    category: 'components',
  },
  {
    label: 'JsonLd',
    href: '/components/jsonld',
    description: 'Componente de dados estruturados',
    category: 'components',
  },
  {
    label: 'Optimized Image',
    href: '/components/optimized-image',
    description: 'Componente de imagem otimizada',
    category: 'components',
  },
  {
    label: 'Protected Route',
    href: '/components/protected-route',
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            ...
            >
              ...
              <span className="font-semibold text-lg">Aqua9 Boilerplate</span>
            </Link>
          </div>
